...
def create_overview(available_configs, filename):
    
    results = list()
    
    for config in available_configs:
        result_dict = get_overview(config)
